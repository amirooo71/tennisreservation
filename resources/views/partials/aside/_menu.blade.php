    ...
    <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1"
        ...
        <ul class="kt-menu__nav ">
            ...
            @if(auth()->user()->clubs->count())
                ...
                <li class="kt-menu__item  kt-menu__item--submenu {{in_array(Route::currentRouteName(),['admin.statistics.bookings','admin.statistics.canceled']) ? 'kt-menu__item--open' : ''}}"
                    aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                    <a href="javascript:;" class="kt-menu__link kt-menu__toggle">
                    <span class="kt-menu__link-icon">
                ...
                <li class="kt-menu__item  kt-menu__item--submenu {{in_array(Route::currentRouteName(),['admin.creditors.index','admin.debtors.index','admin.financial.coaches_debt_list','admin.financial.coach_pay_form','admin.financial.players_debt_list']) ? 'kt-menu__item--open' : ''}}"
                    aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                    <a href="javascript:;" class="kt-menu__link kt-menu__toggle">
                    <span class="kt-menu__link-icon">
                    ...
                    <div class="kt-menu__submenu ">
                        ...
                        <ul class="kt-menu__subnav">
                            ...
                            <li class="kt-menu__item {{Route::currentRouteName() === 'admin.financial.players_debt_list' ? 'kt-menu__item--active' : ''}}"
                                aria-haspopup="true">
                                <a href="{{route('admin.financial.players_debt_list')}}"
                                   class="kt-menu__link ">
                                    <i class="kt-menu__link-bullet kt-menu__link-bullet--dot">
                                        <span></span>
                                    </i>
